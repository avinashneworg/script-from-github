        ...
        stage("AWS-jenkins credentials"){
            steps{
                withCredentials([[
					...
					sh "aws ec2 stop-instances --instance-ids i-0f103a78487a42798 --region ap-southeast-1"
			                sh "aws ec2 stop-instances --instance-ids i-05e7eb76c50bb2564 --region ap-southeast-1"
		}
            }
        }
    }
